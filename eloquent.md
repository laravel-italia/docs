...
Ovviamente devi aggiungere anche la colonna corrispondente al tuo database. Lo [schema builder](/database-migration) di Laravel conta già un helper dedicato alla creazione di tale colonna:
